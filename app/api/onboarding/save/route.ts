// ============================================================
// IterUp — POST /api/onboarding/save
// ------------------------------------------------------------
// Riceve i dati del form di onboarding e:
// 1. upsert su profiles (id = CURRENT_USER_ID)
// 2. upsert su body_metrics per la data odierna (peso attuale)
// 3. calcola TDEE/target macro con lib/tdee.ts
// 4. disattiva i target precedenti e inserisce il nuovo user_targets attivo
// ============================================================
...
function validatePayload(body: unknown): { data: OnboardingPayload } | { error: string } {
