// ============================================================
// IterUp — guardia di scrittura per le API route
// ------------------------------------------------------------
...
// dell'app deployata poteva scrivere/cancellare dati via HTTP, dato
// che ogni route usa la service role key server-side a prescindere
// dal chiamante. Stesso pattern già in uso per il webhook
// /api/activity/ingest (ACTIVITY_WEBHOOK_SECRET), esteso qui a tutte
// le altre route di scrittura con un secret condiviso separato: il
// client (l'app stessa) lo allega via lib/api-client.ts, un
// chiamante esterno senza il token corretto viene respinto con 401.
//
